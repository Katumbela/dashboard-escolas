...
export const outlinedButtonClasses = 'border-primary text-primary hover:bg-primary bg-white hover:text-white';
export const outlinedBlackButtonClasses = 'border-black text-black hover:bg-black bg-white hover:text-white';
export const disabledButtonClasses = 'bg-gray-300 border-gray-500 cursor-not-allowed';
